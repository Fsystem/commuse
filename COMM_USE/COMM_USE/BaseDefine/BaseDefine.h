...
#define PROPERTY_VARIABLE(varType, varName, funName)    \
private: varType __##varName; \
public:  varType get##funName(void) const { return __##varName; } \
public:  void set##funName(varType var)   \
{ \
	__##varName = var; \
}

#define PROPERTY_VARIABLE_READONLY(varType, varName, funName)    \
private: varType __##varName; \
public:  varType get##funName(void) const { return __##varName; }
